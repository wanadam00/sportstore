...
<template>
    <aside
        class="fixed top-0 left-0 z-50 w-64 h-screen pt-2 transition-transform -translate-x-full bg-[#0f0f0f]  md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidenav" id="drawer-navigation">
        <Link :href="route('dashboard')" class="flex items-center">
        <img src="/images/global-white.png" alt="Sport Shop Logo" class="w-28 h-14 object-contain" />
        <!-- <span class="self-center text-2xl font-semibold whitespace-nowrap text-white ml-5">GVT</span> -->
        </Link>
        <div class="overflow-y-auto py-4 px-6 h-full bg-[#0f0f0f]">
            ...
            <ul class="space-y-2">
                <li>
                    <Link :href="route('dashboard')"
                        class="flex items-center p-2 text-base font-medium text-[#F2EED7] hover:text-gray-900 rounded-lg dark:text-[#F2EED7] hover:bg-gray-100 dark:hover:bg-gray-700 group">
